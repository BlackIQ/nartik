...
<head>
    ...
    <link href="http://127.0.0.1/pack/css/bootstrap.min.css" rel="stylesheet">
    <link href="http://127.0.0.1/pack/css/font-awesome.min.css" rel="stylesheet">
    <link href="http://127.0.0.1/pack/css/datepicker3.css" rel="stylesheet">
    <link href="http://127.0.0.1/pack/css/styles.css" rel="stylesheet">

    <!--Custom Font-->
    <link href="https://fonts.googleapis.com/css?family=Montserrat:300,300i,400,400i,500,500i,600,600i,700,700i"
          rel="stylesheet">
    <!--[if lt IE 9]>
    <script src="http://127.0.0.1/pack/js/html5shiv.js"></script>
    <script src="http://127.0.0.1/pack/js/respond.min.js"></script>
    <![endif]-->
</head>
...
<script src="http://127.0.0.1/pack/js/jquery-1.11.1.min.js"></script>
<script src="http://127.0.0.1/pack/js/bootstrap.min.js"></script>
<script src="http://127.0.0.1/pack/js/chart.min.js"></script>
<script src="http://127.0.0.1/pack/js/chart-data.js"></script>
<script src="http://127.0.0.1/pack/js/easypiechart.js"></script>
<script src="http://127.0.0.1/pack/js/easypiechart-data.js"></script>
<script src="http://127.0.0.1/pack/js/bootstrap-datepicker.js"></script>
<script src="http://127.0.0.1/pack/js/custom.js"></script>
<script>
